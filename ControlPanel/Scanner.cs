...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			case "When": t.kind = 4; break;
			case "Show": t.kind = 6; break;
			case "Hide": t.kind = 7; break;
			case "Blink": t.kind = 8; break;
			case "True": t.kind = 9; break;
			case "False": t.kind = 10; break;
			case "NotConnected": t.kind = 11; break;
			case "Signal": t.kind = 12; break;
			case "IsConnected": t.kind = 13; break;
			case "Not": t.kind = 14; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 7:
				recEnd = pos; recKind = 3;
				if (ch == '.' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 7;}
				else {t.kind = 3; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 8:
